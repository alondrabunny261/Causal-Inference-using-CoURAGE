...
def _(pd):
    ...
    data_M1_30_min = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/M1_data/30_min_CO2_aerosols/M1_30_min_meteorological_CO2_aerosol_data.csv"
    )
    ...
    data_S2_30_min = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/S2_data/30_min_CO2_aerosols/S2_30_min_meteorological_CO2_aerosol_data.csv"
    )
    ...
    data_S3_30_min = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/S3_data/30_min_CO2_aerosols/S3_30_min_meteorological_CO2_aerosol_data.csv"
    )
    ...
    return data_M1_30_min, data_S2_30_min, data_S3_30_min
...
def _(pd):
    ...
    data_M1_1_min = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/M1_data/1_min_aerosols/M1_minute_meteorological_with_aerosols_data_wxt.csv"
    )

    data_S2_1_min = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/S2_data/1_min_aerosols/S2_minute_meteorological_with_aerosols_data_wxt.csv"
    )


    data_S3_1_min = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/S3_data/1_min_aerosols/S3_minute_meteorological_with_aerosols_data_wxt.csv"
    )
...
def _(pd):
    ...
    M1_CI_coefs_30_min_m = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/M1_data/30_min_CO2_aerosols/Morning/M1_significant_lags_30_min_C02_aerosols_morning_coefs.csv"
    )


    S2_CI_coefs_30_min_m = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/S2_data/30_min_CO2_aerosols/Morning/S2_significant_lags_30_min_C02_aerosols_morning_coefs.csv"
    )

    S3_CI_coefs_30_min_m = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/S3_data/30_min_CO2_aerosols/Morning/S3_significant_lags_30_min_C02_aerosols_morning_coefs.csv"
    )
    ...
    M1_CI_coefs_30_min_n = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/M1_data/30_min_CO2_aerosols/Night/M1_significant_lags_30_min_C02_aerosols_night_coefs.csv"
    )


    S2_CI_coefs_30_min_n = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/S2_data/30_min_CO2_aerosols/Night/S2_significant_lags_30_min_C02_aerosols_night_coefs.csv"
    )

    S3_CI_coefs_30_min_n = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/S3_data/30_min_CO2_aerosols/Night/S3_significant_lags_30_min_C02_aerosols_night_coefs.csv"
    )
    S3_CI_coefs_30_min_n
    ################################### Rain Events #########################################

    M1_CD_coefs_1_min = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/M1_data/1_min_aerosols/M1_significant_lags_min_aerosols_coefs.csv"
    )

    S2_CD_coefs_1_min = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/S2_data/1_min_aerosols/S2_significant_lags_min_aerosols_coefs.csv"
    )

    S3_CD_coefs_1_min = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/S3_data/1_min_aerosols/S3_significant_lags_min_aerosols_coefs.csv"
    )
...
def _(pd):
    ...
    M1_CI_percentage_30_min_m = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/M1_data/30_min_CO2_aerosols/Morning/M1_lag_summary_morning.csv"
    )


    S2_CI_percentage_30_min_m = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/S2_data/30_min_CO2_aerosols/Morning/S2_lag_summary_morning.csv"
    )


    S3_CI_percentage_30_min_m = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/S3_data/30_min_CO2_aerosols/Morning/S3_lag_summary_morning.csv"
    )


    ################################### Night #########################################
    M1_CI_percentage_30_min_n = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/M1_data/30_min_CO2_aerosols/Night/M1_lag_summary_night.csv"
    )


    S2_CI_percentage_30_min_n = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/S2_data/30_min_CO2_aerosols/Night/S2_lag_summary_night.csv"
    )


    S3_CI_percentage_30_min_n = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/S3_data/30_min_CO2_aerosols/Night/S3_lag_summary_night.csv"
    )


    ################################### Rain #########################################
    M1_CI_percentage_1_min = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/M1_data/1_min_aerosols/M1_lag_summary_rain.csv"
    )


    S2_CI_percentage_1_min = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/S2_data/1_min_aerosols/S2_lag_summary_rain.csv"
    )


    S3_CI_percentage_1_min = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/S3_data/1_min_aerosols/S3_lag_summary_rain.csv"
    )
    return (
...
def _(pd):
    ...
    M1_WPC_30_min_m = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/M1_data/30_min_CO2_aerosols/Morning/WPC_M1_morning_table.csv"
    )

    S2_WPC_30_min_m = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/S2_data/30_min_CO2_aerosols/Morning/WPC_S2_morning_table.csv"
    )

    S3_WPC_30_min_m = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/S3_data/30_min_CO2_aerosols/Morning/WPC_S3_morning_table.csv"
    )

    ################################### Night #########################################
    M1_WPC_30_min_n = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/M1_data/30_min_CO2_aerosols/Night/WPC_M1_evening_table.csv"
    )

    S2_WPC_30_min_n = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/S2_data/30_min_CO2_aerosols/Night/WPC_S2_night_table.csv"
    )

    S3_WPC_30_min_n = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/S3_data/30_min_CO2_aerosols/Night/WPC_S3_evening_table.csv"
    )

    ################################### Rain #########################################
    M1_WPC_1_min = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/M1_data/1_min_aerosols/WPC_M1_rain_event_table.csv"
    )

    S2_WPC_1_min = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/S2_data/1_min_aerosols/WPC_S2_rain_event_table.csv"
    )

    S3_WPC_1_min = pd.read_csv(
        "https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/S3_data/1_min_aerosols/WPC_S3_rain_event_table.csv"
    )
    return (
        M1_WPC_1_min,
        M1_WPC_30_min_m,
...
def _(CI_histograms, Causal_Relations, Causal_Relations_):
    def select_the_CI_of_choice(sel_value, coef_table, facility, lag, color):
        ...
        if sel_value in Causal_Relations:
            ...
            coef_histogram = CI_histograms(
                coef_table, short_label, color, short_label, facility, lag
            )
...
def _(Causal_Relations, Causal_Relations_, mo, pd, px):
    def CI_percentage_display(sel_value, data, lag, names, color):
...
def _(ast, go, px):
    ...
    def CE_histograms(data, selection, facility, data_30_min=False):
        ...
        median_value = data[selection].median()
        median_str = "{:.3g}".format(median_value)
        ...
        if selection in ["Specific Humidity on Temperature", "Specific Humidity on Aerosols"] and data_30_min:

            median_value = median_value
            data[f"{selection} interval 1"] = data[f"{selection} interval 1"]
            data[f"{selection} interval 2"] = data[f"{selection} interval 2"]
...
def _(CE_histograms):
    ...
    def select_the_CE_of_choice(
        WPC_Relations, sel_display, sel_value, data, facility, data_30_min
    ):
        ...
        if sel_value in sel_display:
            ...
            estimation_histogram = CE_histograms(data, sel_value, facility, data_30_min)
...
@app.cell
def _(data_M1_30_min, px):
    # Ejemplo de dos variables del DataFrame
    fig = px.scatter(
        data_M1_30_min,
        x="temperature",
        y="specific humidity",
        title="Correlación entre Temperatura y Humedad Específica",
        labels={
...
def _(px):
    def correlation_plot(
        data, cause, effect, title, label_cause, label_effect, color, rain
    ):

        if rain == True:
            # Filtra el DataFrame solo donde precipitation > 0.1
            data_filtered = data[data["precipitation"] > 0.1]
            ...
            fig = px.scatter(
                ...
                x=cause,
                y=effect,
                title=f"Correlation plot: {label_cause} vs {label_effect}",
                labels={cause: label_cause, effect: label_effect},
                opacity=0.7,
            )
        else:
            # Create correlation plot
...
@app.cell
def _(correlation_plot):
    def select_correlation_plot(sel_val, sel_display, data, title, color, rain):

        sel_display

        if sel_val in sel_display:

            possible_columns = ["specific humidity", "specific humidity c"]

            # Busca la primera columna que exista en el DataFrame
            effect_col = next(
                (col for col in possible_columns if col in data.columns), None
            )
            effect_col = str(effect_col)

            if sel_val == "Temperature-->Temperature":
                cause = "temperature"
                effect = "temperature"
                label_cause = "Temperature"
                label_effect = "Temperature"

            elif sel_val == "Temperature-->Precipitation":
                cause = "temperature"
                effect = "precipitation"
                label_cause = "Temperature"
                label_effect = "Precipitation"

            elif sel_val == "Temperature-->Specific Humidity":
                cause = "temperature"
                if effect_col is not None:
                    effect = effect_col
                label_cause = "Temperature"
                label_effect = "Specific Humidity"

            elif sel_val == "Temperature-->Aerosols":
                cause = "temperature"
                effect = "total_N_conc"
                label_cause = "Temperature"
                label_effect = "Aerosol"

            elif sel_val == "Temperature-->CO2":
                cause = "temperature"
                effect = "co2 molar density"
                label_cause = "Temperature"
                label_effect = "CO2"

            elif sel_val == "Precipitation-->Temperature":
                cause = "precipitation"
                effect = "temperature"
                label_cause = "Precipitation"
                label_effect = "Temperature"

            elif sel_val == "Precipitation-->Precipitation":
                cause = "precipitation"
                effect = "precipitation"
                label_cause = "Precipitation"
                label_effect = "Precipitation"

            elif sel_val == "Precipitation-->Specific Humidity":
                cause = "precipitation"
                if effect_col is not None:
                    effect = effect_col
                label_cause = "Precipitation"
            ...
            elif sel_val == "Precipitation-->Aerosols":
                cause = "precipitation"
                effect = "total_N_conc"
                label_cause = "Precipitation"
                label_effect = "Aerosol"

            elif sel_val == "Precipitation-->CO2":
                cause = "precipitation"
                effect = "co2 molar density"
                label_cause = "Precipitation"
                label_effect = "CO2"

            elif sel_val == "Specific Humidity-->Temperature":
                if effect_col is not None:
                    cause = effect_col
                effect = "temperature"
                label_cause = "Specific Humidity"
                label_effect = "Temperature"

            elif sel_val == "Specific Humidity-->Precipitation":
                if effect_col is not None:
                    cause = effect_col
                effect = "precipitation"
                label_cause = "Specific Humidity"
            ...
            elif sel_val == "Specific Humidity-->Specific Humidity":
                if effect_col is not None:
                    cause = effect_col
                if effect_col is not None:
                    effect = effect_col
            ...
            elif sel_val == "Specific Humidity-->Aerosols":
                if effect_col is not None:
                    cause = effect_col
                effect = "total_N_conc"
                label_cause = "Specific Humidity"
            ...
            elif sel_val == "Specific Humidity--->CO2":
                if effect_col is not None:
                    cause = effect_col
                effect = "co2 molar density"
                label_cause = "Specific Humidity"
            ...
            elif sel_val == "Aerosols-->Temperature":
                cause = "total_N_conc"
                effect = "temperature"
                label_cause = "Aerosols"
                label_effect = "Temperature"

            elif sel_val == "Aerosols-->Precipitation":
                cause = "total_N_conc"
                effect = "precipitation"
                label_cause = "Aerosols"
                label_effect = "Precipitation"

            elif sel_val == "Aerosols-->Specific Humidity":
                cause = "total_N_conc"
                if effect_col is not None:
                    effect = effect_col
                label_cause = "Aerosols"
            ...
            elif sel_val == "Aerosols-->Aerosols":
                cause = "total_N_conc"
                effect = "total_N_conc"
                label_cause = "Aerosols"
                label_effect = "Aerosol"

            elif sel_val == "Aerosols--->CO2":
                cause = "total_N_conc"
                effect = "co2 molar density"
                label_cause = "Specific Humidity"
                label_effect = "CO2"

            elif sel_val == "CO2-->Temperature":
                cause = "co2 molar density"
                effect = "temperature"
                label_cause = "CO2"
                label_effect = "Temperature"

            elif sel_val == "CO2-->Precipitation":
                cause = "co2 molar density"
                effect = "precipitation"
                label_cause = "CO2"
                label_effect = "Precipitation"

            elif sel_val == "CO2-->Specific Humidity":
                cause = "co2 molar density"
                if effect_col is not None:
                    effect = effect_col
                label_cause = "CO2"
            ...
            elif sel_val == "CO2-->Aerosols":
                cause = "co2 molar density"
                effect = "total_N_conc"
                label_cause = "CO2"
                label_effect = "Aerosol"

            elif sel_val == "CO2--->CO2":
                cause = "co2 molar density"
                effect = "co2 molar density"
                label_cause = "CO2"
                label_effect = "CO2"
        ...
        # else:
        #     sel_value = None
    return (select_correlation_plot,)
...
def _(
    ...
    corr_M1_1_min = select_correlation_plot(
        select_causal_relation_CI_1_min.value,
        Causal_Relations,
        data_M1_1_min,
        "title",
    ...
    corr_S2_1_min = select_correlation_plot(
        select_causal_relation_CI_1_min.value,
        Causal_Relations,
        data_S2_1_min,
        "title",
    ...
    corr_S3_1_min = select_correlation_plot(
        select_causal_relation_CI_1_min.value,
        Causal_Relations,
        data_S3_1_min,
        "title",
    ...
    corr_M1_30_min = select_correlation_plot(
        select_causal_relation_CI_30_min.value,
        Causal_Relations,
        data_M1_30_min,
        "title",
    ...
    corr_S2_30_min = select_correlation_plot(
        select_causal_relation_CI_30_min.value,
        Causal_Relations,
        data_S2_30_min,
        "title",
    ...
    corr_S3_30_min = select_correlation_plot(
        select_causal_relation_CI_30_min.value,
        Causal_Relations,
        data_S3_30_min,
        "title",
...
def _(
    ...
    carousel_corr_1_min = mo.carousel(
        [corr_M1_1_min, corr_S2_1_min, corr_S3_1_min]
    )

    carousel_corr_30_min = mo.carousel(
        [corr_M1_30_min, corr_S2_30_min, corr_S3_30_min]
    )
    return carousel_corr_1_min, carousel_corr_30_min


@app.cell
def _(carousel_corr_1_min, carousel_corr_30_min, mo):
    corr_tabs = mo.ui.tabs(
        {
            "1 minute interval data": carousel_corr_1_min,
            "30 minute interval data": carousel_corr_30_min,
        }
    )
    return
...
def _(mo):
    ...
    """
            ...
            mo.center(
                mo.image(
                    src="https://raw.githubusercontent.com/alondrabunny261/Causal-Inference-using-CoURAGE/main/REU%202025/Images/Baltimore_CoURAGE_Facility_IMAGE_jpeg.png",
                    width=600,
                    height=500,
                    rounded=True,
                )
...
@app.cell
def _():
    # data_choose = mo.accordion(
    #     {
    #         "CoURAGE data": C_data_display,
    #         "Correlations between variables": corr_tabs,
    #     }
    # )
    return
...
@app.cell
def _():
    # CC_data_display = mo.vstack([Courage_display, data_choose])
    return
...
def _(CI_30_min_tabs, mo):
    mo.accordion(
        {
            "Causal Discovery": mo.vstack(
                [
                    mo.md(
                        """Causal Discovery or Causal Structure learning is a set of method that recovers the structure of the data-generating process from the data generated. This means that we discover the SCM from the data, not creating an initial DAG from our intuition like traditional causal inference."""
                    ),
                    CI_30_min_tabs,
                ]
            )
